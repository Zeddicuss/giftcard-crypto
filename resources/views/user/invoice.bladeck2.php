    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card mt-3">
                    <div class="card-header"> Invoice for {{ $giftCard->name }}<strong>{{ Carbon\Carbon::now()->format('d-m-Y') }}</strong> <span class="float-end">
                        <img src="{{ $giftCard->photo->first()->url }}" class="card-img-top" alt="{{ $giftCard->name }}">    
                                ...
                                <div class="row align-items-center">
                                    <div class="col-sm-9">
                                        <div class="brand-logo mb-2">
                                            <img src="../images/logo/logo-color.png" alt="" class="width-50 me-2">
                                            <img src="../images/logo/logo-text-color.png" alt="" class="width-200">
                                        </div>
