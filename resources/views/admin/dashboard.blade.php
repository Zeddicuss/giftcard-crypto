								...
								<div class="card coin-card bg-pink">
									...
									<div class="card-body p-4">
										...
										<div class="chart-num">
											@php
											$user = Auth::user();
											$totalEtherum = $user->cryptotransactions()
																->where('crypto_name', 'Etherum')
																->where('status', 'completed')
																->count();
											@endphp
											@if($totalEtherum > 0)
											<br>
											<h2>{{ $totalEtherum }} Etherum sold</h2>
											@else
											<br>
								...
								<div class="card-body pt-0">
									<div class="balance">
										...
										<div class="d-flex justify-content-between align-items-baseline">
											<h4 class="count-num"><a href="{{route('admin.buyform')}}">Pending Crypto Transactions</a></h4>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card exchange">
								...
								<div class="card-body pt-0">
									<div class="balance">
										...
										<div class="d-flex justify-content-between align-items-baseline">
											<h4 class="count-num"><a href="{{route('admin.sell')}}">Sell CryptoCurrency</a></h4>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card exchange">
								...
								<div class="card-body pt-0">
									<div class="balance">
										...
										<div class="d-flex justify-content-between align-items-baseline">
											<h4 class="count-num"><a href="{{route('giftcards')}}">Buy GiftCard</a></h4>
										</div>
									</div>
								</div>
							</div>
